...
/**
  ...
  * }}}
  */
object SysArrayMMMain extends App {
  iotesters.Driver.execute(args, () => new SisArrayMM(32, 3)) {
    c => new SysArrayMMUnitTester(c)
  }
}

object SysArrayMMDriver extends App {
  chisel3.Driver.execute(args, () => new SisArrayMM(32, 3))
}
/**
...
object GCDRepl extends App {
  iotesters.Driver.executeFirrtlRepl(args, () => new SisArrayMM(32, 3))
}